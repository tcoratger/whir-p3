...
mod tests {
    ...
    fn test_folding_pow_bits() {
        ...
        let pow_bits = WhirConfig::<BabyBear, u8, u8, u8>::folding_pow_bits(
            100, // Security level
            soundness,
            field_size_bits,
    ...
    fn test_queries_unique_decoding() {
        ...
        let result = WhirConfig::<BabyBear, u8, u8, u8>::queries(
            SoundnessType::UniqueDecoding,
            security_level,
            log_inv_rate,
        );
    ...
    fn test_rbr_queries_unique_decoding() {
        ...
        let result = WhirConfig::<BabyBear, u8, u8, u8>::rbr_queries(
            SoundnessType::UniqueDecoding,
            log_inv_rate,
            num_queries,
        );
    ...
    fn test_list_size_bits_conjecture_list() {
        ...
        for (num_variables, log_inv_rate, log_eta, expected) in cases {
            let result = WhirConfig::<BabyBear, u8, u8, u8>::list_size_bits(
                SoundnessType::ConjectureList,
                num_variables,
                log_inv_rate,
                log_eta,
    ...
    fn test_rbr_ood_sample_conjecture_list() {
        ...
        {
            let result = WhirConfig::<BabyBear, u8, u8, u8>::rbr_ood_sample(
                SoundnessType::ConjectureList,
                num_variables,
                log_inv_rate,
                log_eta,
    ...
    fn test_ood_samples_unique_decoding() {
        ...
        assert_eq!(
            WhirConfig::<BabyBear, u8, u8, u8>::ood_samples(
                100,
                SoundnessType::UniqueDecoding,
                10,
                3,
