...
// For each i, E_out is the vector with the evalutions
// eq(w_{i+1}, ..., l0, w_{l/2 + l0 + 1}, ..., w_l ; x) for all x in {0,1}^{l/2 - i}
...
// Algorithm 5. Page 18.
// We compute the remaining sumcheck rounds, from round l0 + 2 to round l.
